...
console.log(`\n=== Counting ALL February 2025 worklogs with accountKey ===`);
...
async function fetchAll() {
    ...
    if (allWorklogs.length > 0) {
        ...
        allWorklogs.slice(0, 5).forEach((log, i) => {
            ...
            console.log(`   Description: ${(log.description || 'N/A').substring(0, 50)}`);
        });
    }
}

fetchAll().catch(err => console.error('Error:', err));
