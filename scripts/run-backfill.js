const { backfillHistoryData } = require('./app/actions/sync');
...
async function runBackfill() {
    ...
    try {
        ...
        while (hasMore) {
            ...
            // Limit to 5 batches for initial verification to avoid timeouts/overload
            if (batchCount >= 5 && hasMore) {
                console.log("Stopping after 5 batches for safety. Please run again if needed.");
                hasMore = false;
            }
        }
