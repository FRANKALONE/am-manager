        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-50">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-gray-700 font-medium animate-pulse">Cargando Evolutivos AMA...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50 p-6 md:p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Control AMA Evolutivos</h1>
                        <p className="text-gray-600 mt-1">Gestión y seguimiento de evolutivos del proyecto AMA</p>
                    </div>

                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-5 py-2.5 bg-white rounded-lg shadow-sm border border-gray-200">
