                            ...
                            <div className="p-4 space-y-3">
                                ...
                                {!loading && details.ticketTypes && details.ticketTypes.length > 0 && (
                                    <div className="space-y-2">
                                        <h4 className="font-semibold text-sm mb-3">{t('dashboard.details.breakdownByType')}</h4>
                                                                    ...
                                                                    <table className="w-full text-xs">
                                                                        <thead className="bg-muted/50">
                                                                            <tr className="border-b">
                                                                                ...
                                                                                {permissions.is_admin && <th className="p-2 text-left">{t('dashboard.details.origin')}</th>}<th className="p-2 text-right">{t('dashboard.details.hours')}</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            {worklogs.map((w: any, i: number) => {
                                                                                ...
                                                                                return (
                                                                                    <tr key={i} className={`border-b last:border-0 ${isSelected ? 'bg-primary/5' : ''} ${isClaimed ? 'bg-orange-50/50' : ''} ${isRefunded ? 'bg-red-50/30' : ''}`}>
                                                                                        ...
                                                                                        <td className={`p-2 text-right font-medium ${isRefunded ? 'text-red-600' : ''}`}>{formatRate(w.timeSpentHours, 2)}h</td>
                                                                                    </tr>
                                                                                );
                                                                            })}
                                                                        </tbody>
                                ...
                                {!loading && details.regularizations && details.regularizations.length > 0 && (
                                    <div className="space-y-2 mt-4">
                                        <h4 className="font-semibold text-sm mb-3 flex items-center gap-2">
                                            <span className="text-primary">{t('dashboard.details.regularizationsTitle')}</span>
                                        </h4>
                                        <div className="border rounded-lg bg-blue-50/30 border-blue-100">
                                            <table className="w-full text-sm">
                                                <thead className="bg-blue-100/30">
                                                    <tr className="border-b border-blue-100">
                                                        <th className="p-3 text-left font-medium text-blue-900 w-24">{t('dashboard.details.date')}</th>
                                                        <th className="p-3 text-left font-medium text-blue-900 w-40">{t('dashboard.details.type')}</th>
                                                        <th className="p-3 text-left font-medium text-blue-900">{t('dashboard.details.description')}</th>
                                                        <th className="p-3 text-right font-medium text-blue-900 w-24">{t('dashboard.details.quantity')}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {details.regularizations.map((reg: any) => {
                                                        ...
                                                        return (
                                                            <tr key={reg.id} className="border-b last:border-0 border-blue-100">
                                                                <td className="p-3 whitespace-nowrap">{formatDate(reg.date, { year: 'numeric', month: '2-digit', day: '2-digit' })}</td>
