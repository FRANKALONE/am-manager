                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">
                                    {metrics.isEventos ? t('dashboard.avgTicketsPerMonth') : t('dashboard.available')}
                                </CardTitle>
                            ...
                            <CardContent>
                                {metrics.isEventos ? (
                                    <div className="text-2xl font-bold text-blue-600">
                                        {new Intl.NumberFormat(locale, { maximumFractionDigits: 1 }).format(metrics.avgTicketsPerMonth)} <span className="text-xs font-normal text-muted-foreground">{t('dashboard.details.tickets')}</span>
                                    </div>
                                ) : (
