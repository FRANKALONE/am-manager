...
import { Users, Briefcase, BarChart3, RefreshCw, ShieldCheck, UserCheck, ArrowRight, LayoutDashboard, Zap, Activity, Database, Settings, Mail, Globe } from "lucide-react";
                        ...
                        <Card className="border-none shadow-2xl bg-white/70 backdrop-blur-xl overflow-hidden relative group p-1 flex-1 min-h-[300px] flex flex-col ring-1 ring-slate-200/50">
                            ...
                            <CardContent className="p-8 pt-0 space-y-4 flex-1">
                                {[
                                    ...
                                    { href: "/admin/mass-emails", label: "Emails Masivos", desc: "Enviar comunicaciones masivas", icon: Mail, color: "blue" },
                                    { href: "/admin/landings", label: "Landing Pages", desc: "Páginas temporales por roles", icon: Globe, color: "purple" },
